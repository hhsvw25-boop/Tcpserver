    ...
    public partial class SmartBinderView : Window
    {
        ...
        private async void BtnBind_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    System.Windows.MessageBox.Show("⚠ ملف الحمولة غير موجود أو فشل توليده.", "خطأ", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
                    return;
                }
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"فشلت العملية: {ex.Message}", "خطأ", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
            }
        }
        ...
        private AdvancedBindingConfig GetBindingConfigFromUi()
        {
            ...
            {
                System.Windows.MessageBox.Show("⚠ يرجى اختيار ملف APK الهدف أولاً.", "خطأ", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Warning);
                return null;
            }
            ...
            var extraPerms = new System.Collections.Generic.List<string>();
